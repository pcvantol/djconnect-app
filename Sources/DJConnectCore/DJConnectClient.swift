...
public final class DJConnectClient: Sendable {
    ...
    public func clearAskDJHistory() async throws -> DJConnectAskDJHistoryResponse {
        let request = try clearAskDJHistoryRequest()
        return try await decodedResponse(for: request)
    }
    ...
    public func clearAskDJHistoryRequest() throws -> URLRequest {
